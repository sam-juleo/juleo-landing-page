                ...
                <div className="flex flex-col text-center ">
                    ...
                    <div className=" absolute top-1/2 left-1/2 w-full flex flex-col 
                        ...
                        text-white ">
                            ...
                            {/* text-xl lg:text-4xl */}
                        <p className="text-[22px] w-[80%] lg:text-[36px] lg:w-[55%] mt-16  text-center  mt-6 tracking-normal text-white font-normal ">
                        ...
                        <div className=" w-3/2 h-10 mt-[20px] flex justify-center gap-3 lg:mt-[100px] ">
